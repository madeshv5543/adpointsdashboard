  ...
  <div class="full-page" :style="headerStyle">
    <div class="md-toolbar md-transparent md-toolbar-absolute md-theme-default md-elevation-0">
      <div class="md-toolbar-row md-offset">
        ...
        <h3  class="md-title">Register</h3>
      </div> -->
        <!-- <div  class="md-toolbar-section-end">
        <button  type="button" class="md-button md-just-icon md-simple md-round md-toolbar-toggle md-theme-default">
          <div class="md-ripple">
        ...
        <div  class="md-collapse">
          <ul  class="md-list md-theme-default">
            <li  to="/" class="md-list-item">
              <a  href="#/" class="md-list-item-router md-list-item-container md-button-clean router-link-active" mdripple="true">
            ...
            <li  to="/pricing" class="md-list-item">
              <a  href="#/pricing" class="md-list-item-router md-list-item-container md-button-clean" mdripple="true">
                <div class="md-list-item-content md-ripple">
            ...
            <li  to="/register" class="md-list-item">
              <a  href="#/register" class="md-list-item-router md-list-item-container md-button-clean nav-item active router-link-active" mdripple="true">
                <div class="md-list-item-content md-ripple">
                  <i  class="md-icon md-icon-font md-theme-default">person_add</i>
              Register
             
                </div>
              </a>
            </li>
            <li  to="/login" class="md-list-item">
              <a  href="#/login" class="md-list-item-router md-list-item-container md-button-clean" mdripple="true">
                <div class="md-list-item-content md-ripple">
                  <i  class="md-icon md-icon-font md-theme-default">fingerprint</i>
              login
             
                </div>
              </a>
            </li>
            <li  to="/lock" class="md-list-item">
              <a  href="#/lock" class="md-list-item-router md-list-item-container md-button-clean" mdripple="true">
                <div class="md-list-item-content md-ripple">
                  <i  class="md-icon md-icon-font md-theme-default">lock_open</i>
              lock
                      ...
                      <div class="md-layout-item md-size-50 md-medium-size-50 md-small-size-100 mr-auto">
                        <form @submit.prevent="onSubmit()">
                          ...
                          <md-field class="md-form-group" slot="inputs" :class="{error: errors.has('email')}">
                            ...
                            <label>Email...</label>
                            <md-input type="email" name="email" class="input" v-validate="'required|email'" v-model="user.email"></md-input>
                          </md-field>
                          ...
                          <md-field class="md-form-group" slot="inputs" :class="{error: errors.has('password')}">
                            ...
                            <md-input ref="password" v-validate="'required|min:6'" name="password" v-model="user.password"
                              type="password" class="input"></md-input>
                          </md-field>
                          ...
                          <md-field class="md-form-group" slot="inputs" :class="{error: errors.has('confirmpassword')}">
                            ...
                            <md-input v-validate="'required|confirmed:password'" name="confirmpassword" v-model="user.confirmPassword"
                              type="password" class="input"></md-input>
                          </md-field>
                          <div class="error" v-if="errors.has('confirmpassword')">{{errors.first('confirmpassword')}}</div>
                          <md-field>
                            <label for="accountType">Account Type</label>
                            <md-select v-validate="'required'" v-model="user.accountType" name="accountType" id="accountType">
                      ...
                      <div class="md-layout-item md-size-50 md-medium-size-50 md-small-size-100 mr-auto">
                        ...
                        <div class="button-container">
                          <button href="" type="button" class="md-button md-success md-round mt-4 md-theme-default"
                            slot="footer">
                            <div class="md-ripple">
                              <div @click="downloadFile()" class="md-button-content">Save as file</div>
                            </div>
                          </button>
                        </div>
                        <div class="button-container">
                          <button href="" type="button" class="md-button md-success md-round mt-4 md-theme-default"
                            slot="footer">
                            <div class="md-ripple">
                              <div @click="signupsucces()" class="md-button-content" >I saved continue</div>
                            </div>
                          </button>
                        </div>
                      </div>
